...
class Signature(object):
	...
	def __init__(self):
		self.signatures=[[[[0 for y in range(100)] for x in range(100)] for layer in range(4)] for interaction in range(10)]
		...
		for inter in range(6):
			for layer in range(4):
				for i in range(100):
					for j in range(100):
						if self.signatures[inter][layer][i][j]!=0:
		...
		for i in range(20,80):
			for j in range(20,80):
				if self.projection[0][0][i][j]==None: print(". ", end="")
				else: print(self.projection[0][0][i][j], end="")
			print()
	...
	def predict(self, inter, environment):
		if inter<6:
			...
			for layer in range(4):
				for i in range(100):
					for j in range(100):
						sum+=env[layer][i][j]*self.signatures[inter][layer][i][j]
